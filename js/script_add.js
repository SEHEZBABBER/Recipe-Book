...
function funct() {
    ...
    step.classList.add('step_devison'); // Ensure it matches the CSS class name

    step.innerHTML = `
        <input type="text" name="steps" placeholder="Enter the directions to follow" class="step">
        <input type="text" name="temprature" placeholder="C" class="temp">
        <div>
            <i class="fa fa-clock-o"></i>
            <input type="text" name="time" placeholder="min" class="time">
        </div>
